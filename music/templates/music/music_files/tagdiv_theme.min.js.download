...
(function(a){var b=0,c=0,d=0,f=0,e="ontouchstart"in window||0<navigator.msMaxTouchPoints,l="onorientationchange"in window,g=!1,t=!1,x=!1,A=!1,y=!1,P="pointer",C="pointer",Y=[],U=[],na=[],W=[],F=[],aa=[],G=[],r=[],D=[],ba=[],ia=[],m={showScrollbar:function(b,c){b.scrollbarHide&&a("."+c).css({opacity:b.scrollbarOpacity,filter:"alpha(opacity:"+100*b.scrollbarOpacity+")"})},hideScrollbar:function(a,b,c,d,f,e,g,l,t,x){if(a.scrollbar&&a.scrollbarHide)for(var h=c;h<c+25;h++)b[b.length]=m.hideScrollbarIntervalTimer(10*
h,d[c],(c+24-h)/24,f,e,g,l,t,x,a)},hideScrollbarInterval:function(b,c,h,d,e,k,g,l,t){f=-1*b/D[l]*(e-k-g-d);m.setSliderOffset("."+h,f);a("."+h).css({opacity:t.scrollbarOpacity*c,filter:"alpha(opacity:"+t.scrollbarOpacity*c*100+")"})},slowScrollHorizontalInterval:function(b,c,h,d,e,k,g,l,t,x,J,E,A,v,B,q,y,p,H){if(H.infiniteSlider){if(h<=-1*D[q]||h<=-1*ba[q]){var n=a(b).width();if(h<=-1*ba[q]){var z=-1*J[0];a(c).each(function(b){m.setSliderOffset(a(c)[b],z+y);b<E.length&&(E[b]=-1*z);z+=B[b]});h+=-1*
...
1,1),r[q]=-1*E[0]+y,D[q]=r[q]+n-k,G[q]--}}J=!1;k=m.calcActiveOffset(H,h,E,k,G[q],v,x,q);A=(k+G[q]+v)%v;H.infiniteSlider?A!=aa[q]&&(J=!0):k!=F[q]&&(J=!0);if(J&&(v=new m.args("change",H,b,a(b).children(":eq("+A+")"),A,p),a(b).parent().data("args",v),""!=H.onSlideChange))H.onSlideChange(v);F[q]=k;aa[q]=A;h=Math.floor(h);if(q!=a(b).parent().data("args").data.sliderNumber)return!0;m.setSliderOffset(b,h);H.scrollbar&&(f=Math.floor((-1*h-r[q]+y)/(D[q]-r[q]+y)*(g-l-e)),b=e-t,h>=-1*r[q]+y?(b=e-t- -1*f,m.setSliderOffset(a("."+
d),0)):(h<=-1*D[q]+1&&(b=g-l-t-f),m.setSliderOffset(a("."+d),f)),a("."+d).css({width:b+"px"}))},slowScrollHorizontal:function(b,c,h,d,f,e,g,l,t,x,A,y,P,v,B,q,C,p,H,K,Q){var n=m.getSliderOffset(b,"x");e=[];var k=0,z=25/1024*l;frictionCoefficient=Q.frictionCoefficient;elasticFrictionCoefficient=Q.elasticFrictionCoefficient;snapFrictionCoefficient=Q.snapFrictionCoefficient;f>Q.snapVelocityThreshold&&Q.snapToChildren&&!H?k=1:f<-1*Q.snapVelocityThreshold&&Q.snapToChildren&&!H&&(k=-1);f<-1*z?f=-1*z:f>z&&
(f=z);a(b)[0]!==a(p)[0]&&(k*=-1,f*=-2);p=G[B];if(Q.infiniteSlider)var u=r[B],N=D[B];H=[];z=[];for(var M=0;M<P.length;M++)H[M]=P[M],M<c.length&&(z[M]=m.getSliderOffset(a(c[M]),"x"));for(;1<f||-1>f;){f*=frictionCoefficient;n+=f;(n>-1*r[B]||n<-1*D[B])&&!Q.infiniteSlider&&(f*=elasticFrictionCoefficient,n+=f);if(Q.infiniteSlider){if(n<=-1*N){N=a(b).width();var E=0,J=z[0];for(M=0;M<z.length;M++)z[M]<J&&(J=z[M],E=M);M=u+N;z[E]=M;u=-1*H[1]+K;N=u+N-l;H.splice(0,1);H.splice(H.length,0,-1*M+K);p++}if(n>=-1*
u){N=a(b).width();E=0;J=z[0];for(M=0;M<z.length;M++)z[M]>J&&(J=z[M],E=M);M=u-v[E];z[E]=M;H.splice(0,0,-1*M+K);H.splice(H.length-1,1);u=-1*H[0]+K;N=u+N-l;p--}}e[e.length]=n}z=!1;f=m.calcActiveOffset(Q,n,H,l,p,C,F[B],B);u=(f+p+C)%C;Q.snapToChildren&&(Q.infiniteSlider?u!=aa[B]&&(z=!0):f!=F[B]&&(z=!0),0>k&&!z?(f++,f>=P.length&&!Q.infiniteSlider&&(f=P.length-1)):0<k&&!z&&(f--,0>f&&!Q.infiniteSlider&&(f=0)));if(Q.snapToChildren||(n>-1*r[B]||n<-1*D[B])&&!Q.infiniteSlider){(n>-1*r[B]||n<-1*D[B])&&!Q.infiniteSlider?
e.splice(0,e.length):(e.splice(.1*e.length,e.length),n=0<e.length?e[e.length-1]:n);for(;n<H[f]-.5||n>H[f]+.5;)n=(n-H[f])*snapFrictionCoefficient+H[f],e[e.length]=n;e[e.length]=H[f]}k=1;0!=e.length%2&&(k=0);for(n=0;n<h.length;n++)clearTimeout(h[n]);p=(f+p+C)%C;u=0;for(n=k;n<e.length;n+=2)if(n==k||1<Math.abs(e[n]-u)||n>=e.length-2)u=e[n],h[h.length]=m.slowScrollHorizontalIntervalTimer(10*n,b,c,e[n],d,g,l,t,x,A,f,y,P,q,C,v,B,K,p,Q);u=(f+G[B]+C)%C;""!=Q.onSlideComplete&&1<e.length&&(h[h.length]=m.onSlideCompleteTimer(10*
(n+1),Q,b,a(b).children(":eq("+u+")"),p,B));h[h.length]=m.updateBackfaceVisibilityTimer(10*(n+1),c,B,C,Q);W[B]=h;m.hideScrollbar(Q,h,n,e,d,g,l,x,A,B)},onSlideComplete:function(b,c,h,d,f){h=new m.args("complete",b,a(c),h,d,d);a(c).parent().data("args",h);if(""!=b.onSlideComplete)b.onSlideComplete(h)},getSliderOffset:function(b,c){c="x"==c?4:5;if(!g||t||x)b=parseInt(a(b).css("left"),10);else{for(var h=["-webkit-transform","-moz-transform","transform"],d,f=0;f<h.length;f++)if(void 0!=a(b).css(h[f])&&
0<a(b).css(h[f]).length){d=a(b).css(h[f]).split(",");break}b=void 0==d[c]?0:parseInt(d[c],10)}return b},setSliderOffset:function(b,c){c=parseInt(c,10);!g||t||x?a(b).css({left:c+"px"}):a(b).css({msTransform:"matrix(1,0,0,1,"+c+",0)",webkitTransform:"matrix(1,0,0,1,"+c+",0)",MozTransform:"matrix(1,0,0,1,"+c+",0)",transform:"matrix(1,0,0,1,"+c+",0)"})},setBrowserInfo:function(){null!=navigator.userAgent.match("WebKit")?(P="-webkit-grab",C="-webkit-grabbing"):null!=navigator.userAgent.match("Gecko")?
...
getSlideNumber:function(a,b,c){return(a-G[b]+c)%c},calcActiveOffset:function(a,b,c,d,f,e,g,l){f=!1;a=[];var h;b>c[0]&&(h=0);b<c[c.length-1]&&(h=e-1);for(e=0;e<c.length;e++)c[e]<=b&&c[e]>b-d&&(f||c[e]==b||(a[a.length]=c[e-1]),a[a.length]=c[e],f=!0);0==a.length&&(a[0]=c[c.length-1]);for(e=f=0;e<a.length;e++)g=Math.abs(b-a[e]),g<d&&(f=a[e],d=g);for(e=0;e<c.length;e++)f==c[e]&&(h=e);return h},changeSlide:function(b,c,d,f,e,g,l,t,x,A,r,E,y,v,B,q,C,p){m.autoSlidePause(v);for(var h=0;h<f.length;h++)clearTimeout(f[h]);
var n=Math.ceil(p.autoSlideTransTimer/10)+1,k=m.getSliderOffset(c,"x"),z=E[b];z-=k;var u=b-(F[v]+G[v]+q)%q;if(p.infiniteSlider){b=(b-G[v]+2*q)%q;h=!1;0==b&&2==q&&(b=q,E[b]=E[b-1]-a(d).eq(0).outerWidth(!0),h=!0);z=E[b];z-=k;var N=[E[b]-a(c).width(),E[b]+a(c).width()];h&&E.splice(E.length-1,1);for(h=0;h<N.length;h++)Math.abs(N[h]-k)<Math.abs(z)&&(z=N[h]-k)}0>z&&-1==u?z+=a(c).width():0<z&&1==u&&(z-=a(c).width());u=[];m.showScrollbar(p,e);for(h=0;h<=n;h++)N=h,N/=n,N--,N=k+z*(Math.pow(N,5)+1),u[u.length]=
N;n=(b+G[v]+q)%q;for(h=k=0;h<u.length;h++){if(0==h||1<Math.abs(u[h]-k)||h>=u.length-2)k=u[h],f[h]=m.slowScrollHorizontalIntervalTimer(10*(h+1),c,d,u[h],e,g,l,t,x,A,b,r,E,B,q,y,v,C,n,p);0==h&&""!=p.onSlideStart&&(z=(F[v]+G[v]+q)%q,p.onSlideStart(new m.args("start",p,c,a(c).children(":eq("+z+")"),z,b)))}k=!1;p.infiniteSlider?n!=aa[v]&&(k=!0):b!=F[v]&&(k=!0);k&&""!=p.onSlideComplete&&(f[f.length]=m.onSlideCompleteTimer(10*(h+1),p,c,a(c).children(":eq("+n+")"),n,v));W[v]=f;m.hideScrollbar(p,f,h,u,e,g,
l,x,A,v);m.autoSlide(c,d,f,e,g,l,t,x,A,r,E,y,v,B,q,C,p)},changeOffset:function(b,c,h,d,f,e,g,l,t,x,A,y,C,v,B,q,P,p){m.autoSlidePause(v);for(var n=0;n<d.length;n++)clearTimeout(d[n]);p.infiniteSlider||(b=b>-1*r[v]+P?-1*r[v]+P:b,b=b<-1*D[v]?-1*D[v]:b);var k=Math.ceil(p.autoSlideTransTimer/10)+1,z=m.getSliderOffset(c,"x");n=(m.calcActiveOffset(p,b,y,g,G,q,F[v],v)+G[v]+q)%q;var u=y.slice();if(p.snapToChildren&&!p.infiniteSlider)b=y[n];else if(p.infiniteSlider&&p.snapToChildren){for(;b>=u[0];)u.splice(0,
0,u[q-1]+a(c).width()),u.splice(q,1);for(;b<=u[q-1];)u.splice(q,0,u[0]-a(c).width()),u.splice(0,1);n=m.calcActiveOffset(p,b,u,g,G,q,F[v],v);b=u[n]}var N=b-z;b=[];m.showScrollbar(p,f);for(u=0;u<=k;u++){var M=u;M/=k;M--;M=z+N*(Math.pow(M,5)+1);b[b.length]=M}k=(n+G[v]+q)%q;for(u=z=0;u<b.length;u++){if(0==u||1<Math.abs(b[u]-z)||u>=b.length-2)z=b[u],d[u]=m.slowScrollHorizontalIntervalTimer(10*(u+1),c,h,b[u],f,e,g,l,t,x,n,A,y,B,q,C,v,P,k,p);0==u&&""!=p.onSlideStart&&(k=(F[v]+G[v]+q)%q,p.onSlideStart(new m.args("start",
p,c,a(c).children(":eq("+k+")"),k,n)))}z=!1;p.infiniteSlider?k!=aa[v]&&(z=!0):n!=F[v]&&(z=!0);z&&""!=p.onSlideComplete&&(d[d.length]=m.onSlideCompleteTimer(10*(u+1),p,c,a(c).children(":eq("+k+")"),k,v));W[v]=d;m.hideScrollbar(p,d,u,b,f,e,g,t,x,v);m.autoSlide(c,h,d,f,e,g,l,t,x,A,y,C,v,B,q,P,p)},autoSlide:function(a,b,c,d,f,e,g,l,t,x,A,y,r,v,B,q,C){if(!U[r].autoSlide)return!1;m.autoSlidePause(r);Y[r]=setTimeout(function(){!C.infiniteSlider&&F[r]>A.length-1&&(F[r]-=B);m.changeSlide(F[r]+G[r]+1,a,b,c,
d,f,e,g,l,t,x,A,y,r,v,B,q,C);m.autoSlide(a,b,c,d,f,e,g,l,t,x,A,y,r,v,B,q,C)},C.autoSlideTimer+C.autoSlideTransTimer)},autoSlidePause:function(a){clearTimeout(Y[a])},isUnselectable:function(b,c){return""!=c.unselectableSelector&&1==a(b).closest(c.unselectableSelector).length?!0:!1},slowScrollHorizontalIntervalTimer:function(a,b,c,d,f,e,g,l,t,x,A,r,y,v,C,q,P,p,D,F){return setTimeout(function(){m.slowScrollHorizontalInterval(b,c,d,f,e,g,l,t,x,A,r,y,v,C,q,P,p,D,F)},a)},onSlideCompleteTimer:function(a,
b,c,d,f,e){return setTimeout(function(){m.onSlideComplete(b,c,d,f,e)},a)},hideScrollbarIntervalTimer:function(a,b,c,d,f,e,g,l,t,x){return setTimeout(function(){m.hideScrollbarInterval(b,c,d,f,e,g,l,t,x)},a)},updateBackfaceVisibilityTimer:function(a,b,c,d,f){return setTimeout(function(){m.updateBackfaceVisibility(b,c,d,f)},a)},updateBackfaceVisibility:function(b,c,d,f){c=(F[c]+G[c]+d)%d;for(var h=[],e=0;e<2*f.hardwareAccelBuffer;e++){var n=m.mod(c+e-f.hardwareAccelBuffer,d);if("visible"==a(b).eq(n).css("-webkit-backface-visibility")){h[h.length]=
n;var g=m.mod(n+2*f.hardwareAccelBuffer,d),l=m.mod(n-2*f.hardwareAccelBuffer,d);a(b).eq(n).css("-webkit-backface-visibility","hidden");-1==h.indexOf(l)&&a(b).eq(l).css("-webkit-backface-visibility","");-1==h.indexOf(g)&&a(b).eq(g).css("-webkit-backface-visibility","")}}},mod:function(a,b){a%=b;return 0>a?a+b:a},args:function(b,c,d,f,e,g){this.prevSlideNumber=void 0==a(d).parent().data("args")?void 0:a(d).parent().data("args").prevSlideNumber;this.prevSlideObject=void 0==a(d).parent().data("args")?
...
if(h.infiniteSlider&&!fa){b=m.getSliderOffset(a(L),"x");for(c=(G[k]+O)%O*-1;0>c;){var d=0,f=m.getSliderOffset(a(I[0]),"x");a(I).each(function(a){m.getSliderOffset(this,"x")<f&&(f=m.getSliderOffset(this,"x"),d=a)});var e=r[k]+ea;m.setSliderOffset(a(I)[d],e);r[k]=-1*w[1]+p;D[k]=r[k]+ea-K;w.splice(0,1);w.splice(w.length,0,-1*e+p);c++}for(;0<-1*w[0]-ea+p&&h.snapSlideCenter&&wa;){var g=0,n=m.getSliderOffset(a(I[0]),"x");a(I).each(function(a){m.getSliderOffset(this,"x")>n&&(n=m.getSliderOffset(this,"x"),
g=a)});e=r[k]-R[g];m.setSliderOffset(a(I)[g],e);w.splice(0,0,-1*e+p);w.splice(w.length-1,1);r[k]=-1*w[0]+p;D[k]=r[k]+ea-K;G[k]--;F[k]++}for(;b<=-1*D[k];)d=0,f=m.getSliderOffset(a(I[0]),"x"),a(I).each(function(a){m.getSliderOffset(this,"x")<f&&(f=m.getSliderOffset(this,"x"),d=a)}),e=r[k]+ea,m.setSliderOffset(a(I)[d],e),r[k]=-1*w[1]+p,D[k]=r[k]+ea-K,w.splice(0,1),w.splice(w.length,0,-1*e+p),G[k]++,F[k]--}m.setSliderOffset(L,w[F[k]]);m.updateBackfaceVisibility(I,k,O,h);h.desktopClickDrag||a(L).css({cursor:"default"});
...
R[S],m.setSliderOffset(a(I)[S],z),w.splice(0,0,-1*z+p),w.splice(w.length-1,1),r[k]=-1*w[0]+p,D[k]=r[k]+q-K,G[k]--}else q=a(L).width(),g>-1*r[k]+p&&(e=(r[k]+-1*(ja-n-eventX+u)*l-n)*z*-1/l),g<-1*D[k]&&(e=(D[k]+M+-1*(ja-n-eventX)*l-n)*z*-1/l);m.setSliderOffset(L,-1*(ja-n-eventX-e)*l-n+M);h.scrollbar&&(m.showScrollbar(h,J),f=Math.floor((ja-eventX-e-r[k]+u)/(D[k]-r[k]+p)*(v-T-B)*l),g=B,0>=f?(g=B-V- -1*f,m.setSliderOffset(a("."+J),0),a("."+J).css({width:g+"px"})):f>=v-T-V-B?(g=v-T-V-f,m.setSliderOffset(a("."+
J),f),a("."+J).css({width:g+"px"})):m.setSliderOffset(a("."+J),f));"touchmove"==b.type&&(Ca=b.touches[0].pageX);b=!1;e=m.calcActiveOffset(h,-1*(ja-eventX-e),w,K,G[k],O,void 0,k);g=(e+G[k]+O)%O;h.infiniteSlider?g!=aa[k]&&(b=!0):e!=F[k]&&(b=!0);if(b){F[k]=e;aa[k]=g;qa=!0;g=new m.args("change",h,L,a(L).children(":eq("+g+")"),g,g);a(H).data("args",g);if(""!=h.onSlideChange)h.onSlideChange(g);m.updateBackfaceVisibility(I,k,O,h)}}});var Ha=a(window);if(x||t)Ha=a(document);a(n).bind("touchcancel.iosSliderEvent touchend.iosSliderEvent",
...
function(){b.updateSize()});b.st.closeOnContentClick||(l+=" mfp-auto-cursor");l&&b.wrap.addClass(l);e=b.wH=A.height();h={};b.fixedContentPos&&b._hasScrollBar(e)&&(g=b._getScrollbarSize())&&(h.marginRight=g);b.fixedContentPos&&(b.isIE7?a("body, html").css("overflow","hidden"):h.overflow="hidden");g=b.st.mainClass;return b.isIE7&&(g+=" mfp-ie7"),g&&b._addClassToMFP(g),b.updateItemHTML(),C("BuildControls"),a("html").css(h),b.bgOverlay.add(b.wrap).prependTo(b.st.prependTo||d),b._lastFocusedEl=document.activeElement,
setTimeout(function(){b.content?(b._addClassToMFP("mfp-ready"),b._setFocus()):b.bgOverlay.addClass("mfp-ready");f.on("focusin.mfp",b._onFocusIn)},16),b.isOpen=!0,b.updateSize(e),C("Open"),c},close:function(){b.isOpen&&(C("BeforeClose"),b.isOpen=!1,b.st.removalDelay&&!b.isLowIE&&b.supportsTransition?(b._addClassToMFP("mfp-removing"),setTimeout(function(){b._close()},b.st.removalDelay)):b._close())},_close:function(){C("Close");var c="mfp-removing mfp-ready ";if(b.bgOverlay.detach(),b.wrap.detach(),
...
[b.currItem?b.currItem.type:"",d]),b.currItem=c,!b.currTemplate[d]){var f=b.st[d]?b.st[d].markup:!1;C("FirstMarkupParse",f);b.currTemplate[d]=f?a(f):!0}e&&e!==c.type&&b.container.removeClass("mfp-"+e+"-holder");f=b["get"+d.charAt(0).toUpperCase()+d.slice(1)](c,b.currTemplate[d]);b.appendContent(f,d);c.preloaded=!0;C("Change",c);e=c.type;b.container.prepend(b.contentContainer);C("AfterChange")},appendContent:function(a,c){(b.content=a)?b.st.showCloseBtn&&b.st.closeBtnInside&&!0===b.currTemplate[c]?
...
tCounter:"%curr% of %total%"},proto:{initGallery:function(){var c=b.st.gallery,d=!!a.fn.mfpFastClick;return b.direction=!0,c&&c.enabled?(l+=" mfp-gallery",y("Open.mfp-gallery",function(){c.navigateByImgClick&&b.wrap.on("click.mfp-gallery",".mfp-img",function(){return 1<b.items.length?(b.next(),!1):void 0});f.on("keydown.mfp-gallery",function(a){37===a.keyCode?b.prev():39===a.keyCode&&b.next()})}),y("UpdateStatus.mfp-gallery",function(a,c){c.text&&(c.text=N(c.text,b.currItem.index,b.items.length))}),
...
var g="placeholder"in b.createElement("input"),t="placeholder"in b.createElement("textarea"),x=c.fn,A=c.valHooks,y=c.propHooks;g&&t?(x=x.placeholder=function(){return this},x.input=x.textarea=!0):(x=x.placeholder=function(){this.filter((g?"textarea":":input")+"[placeholder]").not(".placeholder").bind({"focus.placeholder":f,"blur.placeholder":e}).data("placeholder-enabled",!0).trigger("blur.placeholder");return this},x.input=g,x.textarea=t,x={get:function(a){var b=c(a),d=b.data("placeholder-password");
return d?d[0].value:b.data("placeholder-enabled")&&b.hasClass("placeholder")?"":a.value},set:function(a,b){var d=c(a),g=d.data("placeholder-password");if(g)return g[0].value=b;if(!d.data("placeholder-enabled"))return a.value=b;""==b?(a.value=b,a!=l()&&e.call(a)):d.hasClass("placeholder")?f.call(a,!0,b)||(a.value=b):a.value=b;return d}},g||(A.input=x,y.value=x),t||(A.textarea=x,y.value=x),c(function(){c(b).delegate("form","submit.placeholder",function(){var a=c(".placeholder",this).each(f);setTimeout(function(){a.each(e)},
...
a.parent().children("ul").hide()):(c=b.siblings(),c.removeClass(tdMenu._openMenuClass),c.find("ul").hide(),c.find("li").removeClass(tdMenu._openMenuClass)),b.addClass(tdMenu._openMenuClass),b.children("ul").show(),tdMenu._getSubmenuPosition(b),d.addClass(tdMenu._openMenuBodyClass))});else{var c={},d,f=!0;b.on("mouseleave",function(){a.parent().removeClass(tdMenu._openMenuClass);a.parent().children("ul").hide();c={}});b.find(".menu-item").hover(function(){var b=jQuery(this),l="",g,t;if(b.hasClass("menu-item-has-children")||
b.hasClass("td-mega-menu"))if(b.parent().hasClass("sf-menu"))if(jQuery.isEmptyObject(c))b.addClass(tdMenu._openMenuClass),b.children("ul").show(),c=b;else{if(b[0]!==c[0]){var x=t=g=0;var A=null;!0===f&&(f=!1,d=setTimeout(function(){a.parent().removeClass(tdMenu._openMenuClass);a.parent().children("ul").hide();b.addClass(tdMenu._openMenuClass);b.children("ul").show();c=b},400));b.on("mousemove",function(e){5<=g?(g=0,A=tdMenu._getMouseAngleDirection(t,x,e.pageX,e.pageY),t=e.pageX,x=e.pageY):(g++,0===
t&&0===x&&(t=e.pageX,x=e.pageY));null!==A&&(85<A||-85>A)&&(a.parent().removeClass(tdMenu._openMenuClass),a.parent().children("ul").hide(),b.addClass(tdMenu._openMenuClass),b.children("ul").show(),b.off("mousemove"),clearTimeout(d),f=!0,c=b)})}}else l=b.siblings(),l.removeClass(tdMenu._openMenuClass),l.find("ul").hide(),l.find("li").removeClass(tdMenu._openMenuClass),b.addClass(tdMenu._openMenuClass),b.children("ul").show(),tdMenu._getSubmenuPosition(b);else b.parent().hasClass("sf-menu")||b.parent().hasClass("top-header-menu")?
jQuery.isEmptyObject(c)||(x=t=g=0,A=null,!0===f&&(f=!1,d=setTimeout(function(){a.parent().removeClass(tdMenu._openMenuClass);a.parent().children("ul").hide();c={}},400)),b.on("mousemove",function(e){5<=g?(g=0,A=tdMenu._getMouseAngleDirection(t,x,e.pageX,e.pageY),t=e.pageX,x=e.pageY):(g++,0===t&&0===x&&(t=e.pageX,x=e.pageY));null!==A&&(85<A||-85>A)&&(a.parent().removeClass(tdMenu._openMenuClass),a.parent().children("ul").hide(),b.off("mousemove"),clearTimeout(d),f=!0,c={})})):(c=b.parent(),l=b.siblings(),
...
a)?g.sidebar_state="case_4_fixed_up":"up"===d&&!0===tdSmartSidebar._is_smaller_or_equal(e,g.sidebar_top)&&(g.sidebar_state="case_2_top_of_content"),"case_1_fixed_down"===g.sidebar_state&&"up"===d||"case_4_fixed_up"===g.sidebar_state&&"down"===d)g.sidebar_state="case_5_absolute";t=0;null!==tdViewport.getCurrentIntervalItem()&&(t=g.sidebar_jquery_obj.parent(".vc_column, .td-main-sidebar, .vc_column-inner, .vc_column_inner").width(),g.sidebar_jquery_obj.width(t));switch(g.sidebar_state){case "case_1_fixed_down":if(!0===
...
var Froogaloop=function(){function a(b){return new a.fn.init(b)}function b(a,b,c){if(!c.contentWindow.postMessage)return!1;var d=c.getAttribute("src").split("?")[0];a=JSON.stringify({method:a,value:b});"//"===d.substr(0,2)&&(d=window.location.protocol+d);c.contentWindow.postMessage(a,d)}function c(a){try{var b=JSON.parse(a.data);var c=b.event||b.method}catch(P){}"ready"==c&&!e&&(e=!0);if(a.origin!=l)return!1;a=b.value;var d=b.data,g=""===g?null:b.player_id;b=g?f[g][c]:f[c];c=[];if(!b)return!1;void 0!==
...
function(a){c.internalStatus=void 0;tdShowVideo.addPlayerStarted(c.player)},!0);tdShowVideo.addItem(c)})});var tdAnimationStack={};
...
(a.itemImgRetinaSrc=jQuery(b).data("img-retina-url"));tdAnimationStack._initialize_item(a);f.push(a)});!0===d?(tdAnimationStack.log("%c live load items ","background: brown; color: white;"),tdAnimationStack._precompute_items(f,b,c),tdAnimationStack.compute_items(d)):(tdAnimationStack.log("%c preload items ","background: brown; color: white;"),function(){for(var a=!0,d=0;d<f.length;d++)if(!1===e[d].complete){a=!1;break}if(!1===a){var t=(new Date).getTime();tdAnimationStack.log("TIMER - started");var x=
setInterval(function(){var d;if((new Date).getTime()-t>tdAnimationStack.max_waiting_for_init)for(clearInterval(x),d=0;d<f.length;d++)f[d].jqueryObj.removeClass(tdAnimationStack._animation_css_class1),f[d].jqueryObj.addClass(tdAnimationStack._animation_css_class2);else{a=!0;for(d=0;d<f.length;d++)if(!1===e[d].complete){a=!1;break}!0===a&&(clearInterval(x),tdAnimationStack.log("TIMER - stopped"),tdAnimationStack._precompute_items(f,b,c),tdAnimationStack.compute_items(!1))}},100)}else tdAnimationStack._precompute_items(f,
